...
1. What are the key strengths of each person on the team?
  ...
  * Michael - Interpersonal skills, communications, problem solving, loops, etc.
  * Mathieu - Adaptability, fluid able to go with the flow, Javascript and HTML strengths. 
...
2. How can you best utilize these strengths in the execution of your project?
  ...
  * Michael - Will be an assit in JS and can jump in and be a collaborator in any area. Also make sure we are hitting goals. 
  * Mathieu - Once structure is established can assist with effeciency and building out of ideas. Strongsuits in building off of others idea. 
...
3. In which professional competencies do you each want to develop greater strength?
  ...
  * Michael - Overall technical skills can be improved- utilizes supplemental learning to better understand syntax.
  * Mathieu - Creativity could be improved, interpersonal communiciation skills, soft skills and social intelligence could be better and being in a team will help to work on that.
...
2. What will your team do if one person is taking over the project and not letting the other members contribute?
  ...
  * We can establish a lead member (Dustin) who can respectfully sit with the party who is taking over and remind them of the group nature and the importance of collaboration. 
